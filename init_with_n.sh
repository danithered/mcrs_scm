...
do
	...
	./mcrscm --par_maxtime 20000 --par_poolsize 1000 --par_splitfrom 80 --par_MN 10 --par_output_interval 10 --par_save_interval 1000 --par_ID A7fromn.2_${f} --par_str_pool IN/str/mappingA7.txt --par_quit 8 --par_bubbles $tempin/$g --par_substitution 0.05 >> fromn.txt

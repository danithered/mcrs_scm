...
./src/paramfile_gen.R $(printf "%s%s" "--par_flexPdeg" $(printf ",%s" "${par_flexPdeg[@]}")) $(printf "%s%s" "--par_minPdeg" $(printf ",%s" "${par_minPdeg[@]}")) $(printf "%s%s" "--par_rangePdeg" $(printf ",%s" "${par_rangePdeg[@]}")) $(printf "%s%s" "--par_Emin" $(printf ",%s" "${par_Emin[@]}")) $(printf "%s%s" "--par_c" $(printf ",%s" "${par_c[@]}")) $(printf "%s%s" "--par_b2" $(printf ",%s" "${par_b2[@]}")) $(printf "%s%s" "--par_b1" $(printf ",%s" "${par_b1[@]}")) $(printf "%s%s" "--par_g" $(printf ",%s" "${par_g[@]}")) $(printf "%s%s" "--par_deletion" $(printf ",%s" "${par_deletion[@]}")) $(printf "%s%s" "--par_insertion" $(printf ",%s" "${par_insertion[@]}")) $(printf "%s%s" "--par_substitution" $(printf ",%s" "${par_substitution[@]}")) $(printf "%s%s" "--par_save_interval" $(printf ",%s" "${par_sigma[@]}")) $(printf "%s%s" "--par_ll" $(printf ",%s" "${par_ll[@]}")) $(printf "%s%s" "--par_seed_file" $(printf ",%s" "${par_seed_file[@]}")) $(printf "%s%s" "--par_load" $(printf ",%s" "${par_load[@]}")) $(printf "%s%s" "--par_savedir" $(printf ",%s" "${par_savedir[@]}")) $(printf "%s%s" "--par_output_filename" $(printf ",%s" "${par_output_filename[@]}")) $(printf "%s%s" "--par_outdir" $(printf ",%s" "${par_outdir[@]}")) $(printf "%s%s" "--par_str_pool" $(printf ",%s" "${par_str_pool[@]}")) $(printf "%s%s" "--par_seed" $(printf ",%s" "${par_seed[@]}")) $(printf "%s%s" "--par_save_interval" $(printf ",%s" "${par_save_interval[@]}")) $(printf "%s%s" "--par_output_interval" $(printf ",%s" "${par_output_interval[@]}")) $(printf "%s%s" "--par_maxtime" $(printf ",%s" "${par_maxtime[@]}")) >> $direct/$file
